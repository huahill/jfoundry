...
| REST Problem Details | HTTP APIs need JFoundry's RFC 9457 error contract. | `jfoundry-webmvc-spring-boot-starter` | `jfoundry-web-quarkus-runtime` | `jfoundry-web-helidon-runtime` | [REST Problem Details](problem-details.md) |
