...
| Web | HTTP APIs need RFC 9457 problem responses or safe server/client diagnostic logging. | `jfoundry-webmvc-spring-boot-starter` and `jfoundry-restclient-spring-boot-starter` | `jfoundry-web-quarkus-runtime` | `jfoundry-web-helidon-runtime` | [Web](web.md) |
