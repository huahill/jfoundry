...
| `DomainEventPersistenceAutoConfiguration` | Repository `AggregateEventRegistrar` injector | `DomainEventContext` and `AggregateEventRegistrarAware` are on the classpath. |
