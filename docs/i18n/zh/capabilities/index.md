...
| Web | HTTP API 需要 RFC 9457 问题响应或安全的服务端/客户端诊断日志。 | `jfoundry-webmvc-spring-boot-starter` 与 `jfoundry-restclient-spring-boot-starter` | `jfoundry-web-quarkus-runtime` | `jfoundry-web-helidon-runtime` | [Web](web.md) |
