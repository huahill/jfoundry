...
- `jfoundry-core/jfoundry-starters` and `jfoundry-runtime/jfoundry-spring/starters` should assemble existing capabilities; avoid placing domain logic, persistence logic, or broker-specific behavior directly in starters.
